                ...
                <div className="lg:col-span-5 space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                     <div className="p-5 rounded-2xl bg-brand-card/40 border border-brand-border/10 hover:border-brand-accent/30 transition-all group/stat hover:scale-[1.02] duration-500">
                        <p className="text-[10px] font-black text-brand-text-muted uppercase tracking-[0.3em] mb-2 group-hover/stat:text-brand-accent transition-colors leading-none whitespace-nowrap">Damage</p>
                     ...
                     <div className="p-5 rounded-2xl bg-brand-card/40 border border-brand-border/10 hover:border-brand-accent/30 transition-all group/stat hover:scale-[1.02] duration-500">
                        <p className="text-[10px] font-black text-brand-text-muted uppercase tracking-[0.3em] mb-2 group-hover/stat:text-brand-accent transition-colors leading-none whitespace-nowrap">Chance</p>
                        <div className="flex items-baseline gap-2">
